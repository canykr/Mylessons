namespace DateTimeMetotlari
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string tarih3 = DateTime.Today.ToString("yyyy.MM.dd"); // YYYY.MM.DD formatında
            string tarih4 = DateTime.Today.ToString("yyyyMMdd"); // YYYYMMDD formatında
            ...
            DateTime ayinSonGunu = new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1).AddMonths(1).AddDays(-1);
            DateTime ayinSonGunu1= ayinIlkGunu.AddMonths(1).AddDays(-1);

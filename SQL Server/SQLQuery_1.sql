...
--SUM Function = tablonun içindeki satırlara ait istenene kolonun toplam değerini bize döner
select SUM(UnitPrice) FROM dbo.OrderDetails
...
select COUNT(*) as KayitSayisi from dbo.Categories

--MIN Fuction = tablonun içindeki ilgili kolonun en küçük verisini geriye döner
select MIN(Unitprice) from dbo.Products

--MAX Function = tablonun içindeki ilgili kolonun en büyükverisini geriye döner
